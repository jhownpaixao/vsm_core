...
class VSM_ContextMenu extends ScriptedWidgetEventHandler
{
	...
	void Init(Widget layoutRoot, bool builtIn = false)
	{
		...
		{
			m_context_menu_root_widget = GetGame().GetWorkspace().CreateWidgets("vsm_core/Data/Layouts/day_z_inventory_context_menu.layout", layoutRoot);
	...
	void Show(int x, int y)
	{
		...
		// align buttons
		float button_height_percent = 0.03;  // button height is 4% of screen height
